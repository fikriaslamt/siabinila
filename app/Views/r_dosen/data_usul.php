...
<H2 style="margin-left:95px"><a href="#">DATA PENGAJUAN SEMINAR USUL</H2>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= base_url('Dosen/tolak_usul/'.$data["npm"])?>"><button class="btn btn-danger btn-sm">TOLAK</button></a>
                    </td>
