...
<div class="kotak-form">
    <form action="<?= base_url('Cetakan/surat_keringanan_ukt_50')?>" method="post">
        ...
        <label for="sks">Jumlah SKS yang akan di ambil :</label>
        <input type="text" name="sks" class="form_text" placeholder="Jumlah SKS yang akan di ambil">
