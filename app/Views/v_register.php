        ...
        <div class="card-body">
            <form action="<?= base_url('Login/add_register')?>" method="POST">
                ...
                <div class="radio-wrapper">
                    ...
                    <label class="form-control" for="rd1"><input type="radio" name="jenis_kelamin" id="rd1" value="Laki-laki" required/> Laki-laki</label>
                    </div>
                    <div class="radio-item">
                    <label class="form-control" for="rd2"><input type="radio" name="jenis_kelamin" id="rd2" value="Perempuan" /> Perempuan</label>
                    </div>
                    <div class="radio-item">
                    <label class="form-control" for="rd3"><input type="radio" name="jenis_kelamin" id="rd3" value="Lainnya" /> Lainnya</label>
                    </div>
                </div>
